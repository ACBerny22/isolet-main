...
export default function BarraNav() {
  ...
  return (
    ...
    {isUserValid && domLoaded && 
      <div className='flex justify-between bg-zinc-900 py-5 px-8 text-white items-center'>  
        <div className='flex gap-3 items-center'>
          <div className='w-16'>
            <img src="/isolet.png" alt="" />
          </div>
          <Link className='text-2xl' href ="/">ISOLET SALON</Link>
        </div>
        ...
        menu && 
          <div className={`fixed top-0 right-0 h-screen bg-white p-20 rounded-xl border animated-div z-50`}>
